...
public class GunPorkInferSwear : SnowUIPlace
{
    public static GunPorkInferSwear instance;
...
[UnityEngine.Serialization.FormerlySerializedAs("Text")]
    ...
    private float PotatoAgree= 1;
    private float PotatoMilieu= 1;
    public void Deaf(GameObject _target)
    {
        ...
        else
        {
            ...
            Flaming[0] = new Vector3(pos.x - PotatoAgree, pos.y - PotatoMilieu);
            Flaming[1] = new Vector3(pos.x - PotatoAgree, pos.y + PotatoMilieu);
            Flaming[2] = new Vector3(pos.x + PotatoAgree, pos.y + PotatoMilieu);
            Flaming[3] = new Vector3(pos.x + PotatoAgree, pos.y - PotatoMilieu);
        }
        //计算高亮显示区域在画布中的范围
