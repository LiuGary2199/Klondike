...
{
    public static SOHOShopManager instance;
    ...
    public void InitSOHOShop()
    {
        SOHOShopDataManager.instance.InitShopData();

        isReady = true;

        ADManager.Instance.RegisterPlayCallback((adType) => {
    ...
    {
        CashRedeemManager.instance.AddCashBalance();
    }
    ...
    public void AddCashoutPreCondition(string name, double addValue)
    {
        CashRedeemManager.instance.AddPreCondition(name, addValue);
    }
    ...
    {
        CashRedeemManager.instance.AddTaskValue(type, addValue);
        GoldRedeemManager.instance.AddTaskValue(type, addValue);
    }
    ...
    public void SetTaskValue(string type, double newValue)
    {
        Debug.Log("soho type:" + type + ",new value:" + newValue);
        SOHOShopDataManager.instance.SetStaticCashoutTaskValue(type, newValue);
        CashRedeemManager.instance.AddTaskValue(type, 0);
        GoldRedeemManager.instance.AddTaskValue(type, 0);
    }
