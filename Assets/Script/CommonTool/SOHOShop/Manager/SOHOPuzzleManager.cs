...
public class SOHOPuzzleManager : MonoBehaviour
{
    ...
    public void initPuzzle()
    {
        ...
        string[] keys = new string[SOHOShopDataManager.instance.shopJson.puzzle_multi_group.Count];
        SOHOShopDataManager.instance.shopJson.puzzle_multi_group.Keys.CopyTo(keys, 0);
        ...
        {
            puzzle_multi_group.Add(key, SOHOShopDataManager.instance.shopJson.puzzle_multi_group[key]);
        }
    }
