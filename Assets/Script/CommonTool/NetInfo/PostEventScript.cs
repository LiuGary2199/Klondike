    ...
    public void sendGameProgress(List<string> valueList = null)
    {
        ...
        if (valueList == null)
        {
            valueList = new List<string>() {
                SaveDataManager.GetDouble(CConfig.sv_Token).ToString(), //现金余额
                SaveDataManager.GetDouble(CConfig.sv_CumulativeToken).ToString(), //累计现金
                SaveDataManager.GetDouble(CConfig.sv_GoldCoin).ToString(), //金币余额
                SaveDataManager.GetDouble(CConfig.sv_CumulativeGoldCoin).ToString(),//累计金币
            };
        }
