...
public class ShedLineRancher
{
    ...
    public static void CudGray(string key, bool value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static bool FarGray(string key)
    {
        try
        {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void CudStench(string key, string value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static string FarStench(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void CudReach(string key, float value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static float FarReach(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void CudWit(string key, int value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static int FarWit(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void CudWitQuick(string key, int[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static int[] FarWitQuick(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void CudReachQuick(string key, float[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static float[] FarReachQuick(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void CudStenchQuick(string key, string[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static string[] FarStenchQuick(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void CudScrape2(string key, Vector2 value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Vector2 FarScrape2(string key)
    {
        Vector2 Vector2;
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void CudScrape3(string key, Vector3 value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Vector3 FarScrape3(string key)
    {
        Vector3 vector3;
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void CudProminence(string key, Quaternion value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Quaternion FarProminence(string key)
    {
    ...
    public static void CudEmbryo(string key, double value)
    {
        PlayerPrefs.SetString(key, value.ToString());
    }

    public static double FarEmbryo(string key)
    {
