...
public class MusicMgr : MonoSingleton<MusicMgr>
{
    ...
    public bool VibrateSwitch
    {
        get
        {
            _VibrateSwitch = SaveDataManager.GetBool("_VibrateSwitch");
            return _VibrateSwitch;
        }
        set
        {
            _VibrateSwitch = value;
            SaveDataManager.SetBool("_VibrateSwitch", _VibrateSwitch);
        }
    }
    ...
    protected override void Awake()
    {
        if (!PlayerPrefs.HasKey("first_music_setBool") || !SaveDataManager.GetBool("first_music_set"))
        {
            ...
            SaveDataManager.SetBool("_VibrateSwitch", true);
            SaveDataManager.SetBool("AutoCollectSwitch", true);
        }
    ...
    public void PlayVibrate(PresetType presetType)
    {
        if (!VibrateSwitch)
            return;
